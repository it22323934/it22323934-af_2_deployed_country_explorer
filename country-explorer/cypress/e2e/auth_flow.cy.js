describe("Authentication Flow", () => {
  ...
  describe("Complete User Flows", () => {
    it("should complete the sign up to sign in flow", () => {
      // Intercept API calls
      cy.intercept("POST", "/api/auth/signup", {
        statusCode: 201,
        body: { success: true },
      ...
      cy.get("input#username").type("flowuser");
      cy.get("input#email").type("flow@example.com");
      ...
      // Fill out sign in form with same credentials
      cy.get("input#email").should("be.visible").type("flow@example.com");
      cy.get("input#password").should("be.visible").type("securepassword");
      cy.get('button[type="submit"]').click();
